 ...
 */
public class MeCallFragment extends HBaseFragment {
    ...
    public void setFriend(ComBean comBean3) {
        if (comBean3 == null) return;
        if (comBean3.getFriendList() == null) return;
        if (adapter==null) return;
        List<ComBean.FriendListBean> data = matchFriend(comBean3.getFriendList());
