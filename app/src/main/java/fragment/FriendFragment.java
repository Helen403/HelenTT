 ...
 */
public class FriendFragment extends HBaseFragment {
    ...
    public void findViews() {
        friendListview = (ListView) contentView.findViewById(R.id.friend_listview);
    }
    ...
    public void setFriend(ComBean comBean1) {
        if (comBean1.getFriendList() == null) return;
        if (adapterFriend == null) return;
        List<ComBean.FriendListBean> data = matchFriend(comBean1.getFriendList());
